...
const cargolift_logger_service_1 = require("./cargolift-logger.service");
...
exports.CargoliftCDILoggerModule = CargoliftCDILoggerModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [cargolift_logger_service_1.CargoliftCDILogger],
        exports: [cargolift_logger_service_1.CargoliftCDILogger],
    })
], CargoliftCDILoggerModule);
//# sourceMappingURL=cargolift-logger.module.js.map